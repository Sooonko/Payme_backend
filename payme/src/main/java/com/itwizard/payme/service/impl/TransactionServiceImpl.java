...
public class TransactionServiceImpl implements TransactionService {
        ...
        public TransactionResponse sendMoney(UUID fromUserId, TransactionRequest request) {
                ...
                return mapToResponse(savedTransaction, fromWallet.getId());
        }
        ...
        public List<TransactionResponse> getTransactionHistory(UUID userId) {
                ...
                return transactions.stream()
                                .map(t -> mapToResponse(t, wallet.getId()))
                                .toList();
        }
        ...
        private TransactionResponse mapToResponse(Transaction transaction, UUID myWalletId) {
                TransactionFlow flow = TransactionFlow.OUTFLOW;
                if (transaction.getToWallet() != null && transaction.getToWallet().getId().equals(myWalletId)) {
